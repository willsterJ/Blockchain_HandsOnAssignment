...
// ME: LENDER ---------------------------------------------------------------
	// INVOKE: issueAcceptedLC (Exporter's Bank)
	return invokeCC.invokeChaincode(Constants.EXPORTER_ORG, Constants.CHAINCODE_VERSION, 'issueLC', [tradeID, 'lc8349', '12/31/2018', 'E/L', 'B/L'], 'ExportersBank');
}, (err) => {
	console.log('\n');
	console.log('------------------------');
	console.log('CHAINCODE QUERY FAILED:', err);
	console.log('getAcceptedLCStatus FAILED');
	console.log('------------------------');
	console.log('\n');
	process.exit(1);
})
.then(() => {
	...
	console.log('------------------------------');
	console.log('CHAINCODE INVOCATION COMPLETE');
	console.log('issueAcceptedLC SUCCEEDED');
	console.log('------------------------------');
	console.log('\n');

// INVOKE: acceptAcceptedLC (Lender Bank)
	return invokeCC.invokeChaincode(Constants.LENDER_ORG, Constants.CHAINCODE_VERSION, 'acceptAcceptedLC', [tradeID], 'LendersBank');
}, (err) => {
	console.log('\n');
	console.log('------------------------');
	console.log('CHAINCODE QUERY FAILED:', err);
...
.then(() => {
	...
	console.log('------------------------------');
	console.log('CHAINCODE INVOCATION COMPLETE');
	console.log('acceptAcceptedLC SUCCEEDED');
	console.log('------------------------------');
	console.log('\n');
...
// ME: LENDER ------------------------------------------------------------------
	...
	return invokeCC.invokeChaincode(Constants.LENDER_ORG, Constants.CHAINCODE_VERSION, 'requestPayment', [tradeID], 'Lender');
}, (err) => {
	console.log('\n');
	console.log('------------------------');
	console.log('CHAINCODE QUERY FAILED:', err);
...
.then(() => {
	...
	// INVOKE: makePayment (Lender)   from lender to exporter
	return invokeCC.invokeChaincode(Constants.LENDER_ORG, Constants.CHAINCODE_VERSION, 'makePayment', [tradeID], 'Lender');
}, (err) => {
	console.log('\n');
	console.log('-----------------------------');
	console.log('CHAINCODE INVOCATION FAILED:', err);
